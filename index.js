...
const GOGO_DOMAIN = process.env.GOGO_DOMAIN || 'cfv.bafhzn.tk';              // 固定隧道域名，留空即启用临时隧道
const GOGO_AUTH = process.env.GOGO_AUTH || '{"AccountTag":"0a789bb28a9d5ec2ef558519bb536ac2","TunnelSecret":"3Ym3VhPCELSa3wy5S/QWnztJq5x3ATxPnUnCnXmDTdk=","TunnelID":"42b9299a-31c0-47d0-83ae-20bd47003b9c"}';                 // 固定隧道json或token，留空即启用临时隧道
